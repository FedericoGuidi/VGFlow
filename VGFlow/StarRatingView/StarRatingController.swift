...
class UIStarRatingView: UIView {
    ...
    @IBInspectable var starColor: UIColor = .lightGray.withAlphaComponent(0.5) {
        didSet {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        self.setupView(rating: 0, color: .lightGray.withAlphaComponent(0.5), starRounding: .roundToHalfStar)
    }
